...
// char MQTT_Server  [MAX_MQTT_SERVER_LEN + 1]   = "server name";
char MQTT_Server  [MAX_MQTT_SERVER_LEN + 1]   = "";

#define MAX_MQTT_USER_LEN      34
// char MQTT_User  [MAX_MQTT_USER_LEN + 1]   = "mqtt user";
char MQTT_User  [MAX_MQTT_USER_LEN + 1]   = "";

#define MAX_MQTT_PASSWD_LEN      34
// char MQTT_Passwd  [MAX_MQTT_PASSWD_LEN + 1]   = "mqtt password";
char MQTT_Passwd  [MAX_MQTT_PASSWD_LEN + 1]   = "";
...
MenuItem myMenuItems [] =
{
  ...
  { "mqtu", "MQTT User",   MQTT_User,    MAX_MQTT_USER_LEN },
  { "mqtp", "MQTT Password",   MQTT_Passwd,    MAX_MQTT_PASSWD_LEN },
  // { "tst", "TST Server",   MQTT_Server,    MAX_MQTT_SERVER_LEN },
};
